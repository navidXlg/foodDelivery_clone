    ...
    return <div className="flex items-center mt-14 max-w-screen-2xl flex-col text-center lg:text-right gap-10 lg:flex-row 3xl:mx-auto">
              ...
              className="flex flex-col gap-8 bg-white px-3 py-5 shadow-lg rounded-md min-w-[370px]">
                ...
                <div className = "relative w-full min-w-[200px] h-10">
                  <input type = "text" value={salesCredential.storeName} id="storeName" onChange={(event)=>handelFormChange(event)} className={inputClass} placeholder=" "/>
                  <label className={labelClass}>نام فروشگاه</label>
                </div>
                <div className = "relative w-full min-w-[200px] h-10">
                  <input type = "text" value={salesCredential.name} id="name" onChange={(event)=>handelFormChange(event)} className={inputClass} placeholder=" "/>
                  <label className={labelClass}>نام مالک فروشگاه</label>
                </div>
                <div className = "relative w-full min-w-[200px] h-10">
                  <input type = "text" value={salesCredential.lastName} id="lastName" onChange={(event)=>handelFormChange(event)} className={inputClass} placeholder=" "/>
