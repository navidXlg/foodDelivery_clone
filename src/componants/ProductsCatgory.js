...
export default function ProductsCatgory({className, ...rest}){
   ...
   return (
      <div className={`hidden gap-3 text-sm md:flex items-center justify-around w-3/4 w-max-[76rem] backdrop-blur-md backdrop-contrast-125 rounded-lg ${className}`} dir="rtl">
