...
export default function Hero (){
    ...
    return  <div className="max-w-lg absolute top-1/4 sm:top-1/4 md:top-1/3 z-40 text-center bg-opacity-50 md:bg-opacity-0 p-8 rounded-xl  md:p-0 bg-gray-50 text-gray-800 transform translate-x-1/2 md:transform-none translate-y-1/2 md:text-right right-1/2  md:right-10">
